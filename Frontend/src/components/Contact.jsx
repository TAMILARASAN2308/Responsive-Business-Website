...
function Contact() {
  ...
  return (
    <>
    <section className='flex justify-center items-center bg-secondary gap-12 px-5 py-10 bg-slate-100 md:h-[560px] w-[360px] md:min-w-full font-poppins-font' id='contact'>
