...
function Contact() {
  ...
  return (
    <>
    <section className='flex justify-center items-center bg-secondary gap-12 px-5 py-10 bg-slate-100 md:h-[560px] w-full max-w-[400px] md:min-w-full font-poppins-font' id='contact'>
      <div className='flex flex-col w-[313px] md:w-[664px] '>
          ...
          <form className='flex flex-col gap-4 pb-5 w-full max-w-2xl'>
              ...
              <button className=" bg-green-custom w-[90px] h-[36px]  text-white md:mt-4 rounded-[4px] hover:bg-green-700 transition">Submit</button>    
          </form>
