...
<section id="growing-business" className="md:hidden h-[620px] bg-[#04293C] mt-[10px] relative flex flex-col items-center w-full max-w-[400px]">
...
<section id="brand-logos" className="md:hidden flex justify-center items-center h-[170px] w-full max-w-[400px]">
      <Swiper
        modules={[Pagination]}
        spaceBetween={20}
        slidesPerView={2}
...
<section id="consulting-services" className="md:hidden flex justify-center items-center w-full max-w-[400px]">
    <Swiper
        modules={[Pagination]}
        spaceBetween={20}
        slidesPerView={1} 
...
{/*Services Section*/}
<section className="font-poppins-font bg-[#F4F6FC] w-full h-[1712px] md:w-full md:h-[892px] md:pt-10 flex flex-col  md:items-start" id="services">
...
<section className="md:hidden">
  <div className="bg-[#04293C] pt-14  w-full max-w-[400px] h-[934px] flex flex-col items-center justify-center text-center gap-8 font-poppins-font"style={{ backgroundImage: "url('/images/bt-m.png')" }}>
...
<section  className="md:hidden mt-[-1px]">
    <div className="bg-[#04293C] w-full max-w-[400px] h-[256px] flex flex-col items-center justify-center text-center gap-8 font-poppins-font" style={{ backgroundImage: "url('/images/bt-m3.png')"}}>
...
<section id="about" className="md:hidden flex flex-col items-center gap-8 h-[1558px] mt-[36px] font-poppins-font bg-slate-100 w-full max-w-[400px]">
