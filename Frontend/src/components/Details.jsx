...
function Details() {
  return (
    <>
    {/* Desktop View */}
    <section id="contact-details" className="hidden md:flex justify-center relative w-full h-[190px] bg-white">
    ...
    {/* Mobile View */}
    <section id="contact-details" className="md:hidden relative w-full max-w-[400px] h-[702px] bg-white flex justify-center items-center">
