...
function Footer() {
  return (
    <>
    <section className="hidden md:flex flex-col  items-center bg-[#1D2122] w-full h-[491px] ">
        ...
        <div className="flex justify-between text-white">
            ...
            <div className="flex flex-col gap-3">
                ...
                <button className=" bg-green-custom px-1 py-1 text-white rounded-[4px] w-[73px] h-[36px]">Send</button> 
                </div>
            </div>
        </div>
    ...
    <section className="bg-[#1D2122] min-w-[360px] h-[888px] flex flex-col items-center font-poppins-font gap-4 py-14 md:hidden ">
