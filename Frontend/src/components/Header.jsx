      ...
      <div className="md:hidden">
        {toggleMenu ? (
          <>
            ...
            <nav className="flex justify-between h-[80px] items-center px-[25px] bg-[#0a2c44] text-white w-[360px]">
          ...
          <nav className="flex justify-between items-center px-[25px] h-[80px]  w-[360px]">
